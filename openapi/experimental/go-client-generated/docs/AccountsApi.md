...
[**GetContractsByAccount**](AccountsApi.md#GetContractsByAccount) | **Get** /experimental/v1/accounts/{address}/contracts | List contracts for an account
 ...
 **ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
  **address** | [**string**](.md)| The account address (hex-encoded without 0x prefix). | 
 **optional** | ***AccountsApiGetScheduledTransactionsByAccountOpts** | optional parameters | nil if no parameters

### Optional Parameters
Optional parameters are passed through a pointer to a AccountsApiGetScheduledTransactionsByAccountOpts struct
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
