...
/*
NetworkApiService Get Network Parameters
...
func (a *NetworkApiService) NetworkParametersGet(ctx context.Context) (NetworkParameters, *http.Response, error) {
	var (
		...
		localVarReturnValue NetworkParameters
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/network/parameters"
