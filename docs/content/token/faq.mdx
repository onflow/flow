...
Our investors'XXXXXXXXXXXXXX tokens are allowed to be liquidated straight line over 24 months - all those tokens are available to stake and earn rewards on day one, but the principal can't be unlocked until the longer of the unbonding period and the lock-up period for that portion of tokens.
