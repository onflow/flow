...
description: How the Flow protocol punishes bad behavior be slashing stakers tokens
---
...
You can find more details on the conditions under which a node is slashed in the Flow white papers.
