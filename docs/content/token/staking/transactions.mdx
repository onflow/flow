...
sidebar_title: Staking Transactions Reference
---
...
Please see the locked tokens documentation for information for staking with locked tokens.
Docs for staking with unlocked tokens will be updated when unlocked tokens are available to stake with.

## Delegator Transactions

Please see the locked tokens documentation for information for delegatin with locked tokens.
