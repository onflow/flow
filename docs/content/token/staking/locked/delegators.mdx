...
Once an account has registered as a delegator, they cannot register a second time.
...
the **token holder** can use the **Delegate New Locked FLOW** ([TH.13](../transactions/#token-holder)) 
transaction with the following arguments:
...
the **token holder** can use the **Re-delegate Unstaked FLOW** ([TH.14](../transactions/#token-holder))
transaction with the following arguments:
...
the **token holder** can use the **Re-delegate Rewarded FLOW** ([TH.15](../transactions/#token-holder))
transaction with the following arguments:
...
the **token holder** can use the **Unstake Delegated FOW** ([TH.16](../transactions/#token-holder))
transaction with the following arguments:
...
the **token holder** can use the **Withdraw Unstaked FLOW ** ([TH.17](../transactions/#token-holder))
transaction with the following arguments:
...
the **token holder** can use the **Withdraw Rewarded FLOW** ([TH.18](../transactions/#token-holder))
transaction with the following arguments:
...
can use the **Get Delegator Info** ([TH.19](../transactions/#token-holder)) script with the following arguments:
