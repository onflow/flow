...
|**`TH.19`**| Get Delegator Info    | [lockedTokens/delegator/get_delegator_info.cdc](https://github.com/onflow/flow-core-contracts/blob/master/transactions/lockedTokens/delegator/get_delegator_info.cdc) |
