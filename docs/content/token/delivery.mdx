...
### Navigate to Flow Port to Create an Address
 ...
 8. Now that you have your deposit address, you can begin the process to claim your FLOW from Dapper Labs
Please submit your details to [this form](https://docs.google.com/forms/d/e/1FAIpQLSdJHHxA4IK6TGHId84YBh_zQ-DVPXLJ3_ektX9TdHiQPcC1LQ/viewform) if you are a FLOW backer. 

Please submit your detils to [this form](https://docs.google.com/forms/d/e/1FAIpQLSeeBuFVXoMmKwF141TD1jL_HTf3XN4-sTphPUYEB-Ed57vJLQ/viewform) if you are claiming a FLOW lease or grant.  
