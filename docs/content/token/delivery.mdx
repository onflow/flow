...
### Creating Account through Blocto's Mobile Application
 ...
 6. Now that you have your deposit address you can begin the process to claim your FLOW from [CoinList](https://coinlist.co/flow/distribution_addresses/new).
...
5. Now that you have your deposit address, you can begin the process to claim your FLOW from CoinList.
...
### Navigate to Flow Port to Create an Address
 ...
 8. Now that you have your deposit address you can begin the process to claim your FLOW from CoinList.
