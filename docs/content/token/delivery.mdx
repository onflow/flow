...
5. Now that you have your deposit address, you can begin the process to claim your FLOW from CoinList. Or if you are a backer and claiming directly from Dapper Labs, that process is located [here](todo). 
