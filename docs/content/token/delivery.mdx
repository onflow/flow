...
5. After you have your deposit address you can begin the process to claim your FLOW from [CoinList](https://coinlist.co/flow/distribution_addresses/new).
...
**IMPORTANT**
Ledger will not be available before the CoinList submission deadline (Monday October 26th @12pm PT). However, you may select it as a preference for future delivery. If you would like to use Ledger for your FLOW distribution, please write the word “ledger” instead of your FLOW address into the text box found here: https://coinlist.co/flow/distribution_addresses/new 
The Flow team will contact you directly once Ledger is available to help you set up your account. 
