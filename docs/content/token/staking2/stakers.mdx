...
These values can be passed into the **Get Operator Node Info** ([TH.04](../transactions/#token-holder)) 
...
This can be done using the **Register Node** ([TH.05](../transactions/#token-holder)) transaction
...
the **token holder** can use the **Stake New Locked FLOW** ([TH.06](../transactions/#token-holder)) 
...
the **token holder** can use the **Re-stake Unstaked FLOW** ([TH.07](../transactions/#token-holder)) 
transaction with the following arguments:
...
the **token holder** can use the **Re-stake Rewarded FLOW** ([TH.08](../transactions/#token-holder)) 
transaction with the following arguments:
...
the **token holder** can use the **Unstake FLOW** ([TH.09](../transactions/#token-holder)) 
transaction.
...
the **token holder** can use the **Withdraw Unstaked FLOW** ([TH.10](../transactions/#token-holder)) 
transaction with the following arguments:
...
the **token holder** can use the **Withdraw Rewarded FLOW** ([TH.11](../transactions/#token-holder)) 
transaction with the following arguments:
