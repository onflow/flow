---
title: Locked Tokens Contract Reference
...
See the [staking documentation](/protocol/core-contracts/flow-id-table-staking) for how to get info about a staked node.
...
See the [staking documentation](/protocol/core-contracts/flow-id-table-staking) for how to get info about a staked delegator.
