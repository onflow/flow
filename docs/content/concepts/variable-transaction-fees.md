...
> **Note**: The changes to variable inclusion costs will be updated in [one of the upcoming sporks](https://docs.onflow.org/nodes/nodes/node-operation/upcoming-sporks/).
