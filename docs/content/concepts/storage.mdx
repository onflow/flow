...
The **FLIP** (Flow Improvement Proposal) for storage fees can be found here: [flips/20201310-storage-fees.md](https://github.com/onflow/flow/blob/master/flips/20201310-storage-fees.md).
