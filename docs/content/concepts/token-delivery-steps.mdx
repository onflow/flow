...
### Install the Blocto App
 ...
 ### Navigate to Flow Port to confirm your Address
 ...
 4. Log-in using the same email address that you used above of signing up for an account in the Blocto App.
 
 5. You should now see the same address in Flow Port that matches the address listed in the Blocto App.
