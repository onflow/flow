...
NOTE: Your tokens are currently not available to be claimed at this time. However, please feel free to review the various provider options below to understand the process. These are instructions that will get you started with claiming your FLOW tokens once this option is available.
</ Callout>
...
5. After you have your deposit address you can begin the process to claim your FLOW from [Coinlist](https://forms.gle/SPbio2oBeu6LYPnc6). Or if you are convertible note investor and claiming directly from Dapper Labs, that [process is located here](https://forms.gle/5ZF2Zb8DM3uc7qRL7).
...
1. If you do not have a Finoa account already, you can create one [here](https://www.finoa.io/).
...
5. Now that you have your deposit address you can begin the process to claim your FLOW from [Coinlist](https://forms.gle/SPbio2oBeu6LYPnc6). Or if you are a convertible note investor and claiming directly from Dapper Labs, that [process is located here](https://forms.gle/5ZF2Zb8DM3uc7qRL7).
