...
### Navigate to Flow Port to Create an Address
 ...
 4. Follow the prompts on the screen to create a new account.

 5. Once your account address is created, you will be automatically logged into Flow Port.

 6. You can easily copy it from the ‘Dashboard’ screen, as shown below:

    ![](https://storage.googleapis.com/flow-resources/documentation-assets/token%20delivery%20assets/FlowPortMyAccount.png)

 7. Now that you have your deposit address you can begin the process to claim your FLOW from Coinlist. Or if you are convertible note investor and claiming directly from Dapper Labs, that process is located here.
