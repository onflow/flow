...
6. After you have your deposit address you can begin the process to claim your FLOW from [Coinlist](https://forms.gle/SPbio2oBeu6LYPnc6). Or if you are convertible note investor and claiming directly from Dapper Labs, that [process is located here](https://forms.gle/5ZF2Zb8DM3uc7qRL7).
...
4. If you want to reference additional documentation regarding Finoa and Flow, please see [instructions here](https://finoa.io/flow).
...
### Navigate to Flow Port to Create an Address
 ...
 8. Now that you have your deposit address you can begin the process to claim your FLOW from [Coinlist](https://forms.gle/SPbio2oBeu6LYPnc6). Or if you are convertible note investor and claiming directly from Dapper Labs, that [process is located here](https://forms.gle/5ZF2Zb8DM3uc7qRL7).
