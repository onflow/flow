...
Below are 5 different ways to create an account and recieve your FLOW tokens. 
...
5. After you have your deposit address you can begin the process to claim your FLOW from [Coinlist](https://coinlist.co/flow/distribution_addresses/new). Or if you are backer and claiming directly from Dapper Labs, that [process is located here](https://forms.gle/5ZF2Zb8DM3uc7qRL7).
...
### Before You Start
 ...
 6. Now that you have your deposit address you can begin the process to claim your FLOW from [Coinlist](https://coinlist.co/flow/distribution_addresses/new). Or if you are backer and claiming directly from Dapper Labs, that [process is located here](https://forms.gle/5ZF2Zb8DM3uc7qRL7).
...
### Navigate to Flow Port to Create an Address
 ...
 8. Now that you have your deposit address you can begin the process to claim your FLOW from Coinlist. Or if you are backer and claiming directly from Dapper Labs, that process is located here.
