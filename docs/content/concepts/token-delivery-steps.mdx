...
<Img src="https://storage.cloud.google.com/flow-resources/documentation-assets/token%20delivery%20assets/kraken_1.png?authuser=7" />
   
 3. Under the list of all assets, locate Flow (FLOW) and select Deposit.
<Img src="https://storage.cloud.google.com/flow-resources/documentation-assets/token%20delivery%20assets/Kraken2.png?authuser=7" />
  
 4. Select GENERATE NEW ADDRESS to create your deposit wallet address.
<Img src="https://storage.cloud.google.com/flow-resources/documentation-assets/token%20delivery%20assets/Kraken3.png?authuser=7" />
...
### Install the Flow App
 ...
 <Img src="https://storage.cloud.google.com/flow-resources/documentation-assets/token%20delivery%20assets/Ledger1.png?authuser=7" />
 ...
 3. In Ledger Live go to Settings > Experimental Features and turn on Developer Mode:
  <Img src="https://storage.cloud.google.com/flow-resources/documentation-assets/token%20delivery%20assets/Ledger2.jpg?authuser=7" />
 ...
 <Img src="https://storage.cloud.google.com/flow-resources/documentation-assets/token%20delivery%20assets/LedgerLive%20Flow%20App.png?authuser=7" />
...
### Navigate to Flow Port to Create an Address
 ...
 2. Click on 'Sign Up' if you need to create a new Flow Account.
  <Img src="https://storage.cloud.google.com/flow-resources/documentation-assets/token%20delivery%20assets/FlowPort%20Login.png?authuser=7" />
 3. Click on Ledger:
 <Img src="https://storage.cloud.google.com/flow-resources/documentation-assets/token%20delivery%20assets/FlowPort%20Wallet.png?authuser=7" />
 4. Follow the prompts on the screen. Plug in your Ledger device and open the Flow App:
 <Img src="https://storage.cloud.google.com/flow-resources/documentation-assets/token%20delivery%20assets/FlowPort%20Ledger%20connect%20screen.png?authuser=7" />
 ...
 <Img src="https://storage.cloud.google.com/flow-resources/documentation-assets/token%20delivery%20assets/FlowPort%20My%20Account.png?authuser=7" />
