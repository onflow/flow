...
6. Now that you have your deposit address you can begin the process to claim your FLOW from [Coinlist](https://forms.gle/SPbio2oBeu6LYPnc6). Or if you are convertible note investor and claiming directly from Dapper Labs, being that [process here](https://forms.gle/5ZF2Zb8DM3uc7qRL7).
