...
### Before You Start
 ...
 6. Now that you have your deposit address you can begin the process to claim your FLOW from [CoinList](https://coinlist.co/flow/distribution_addresses/new). Or if you are a backer and claiming directly from Dapper Labs, that [process is located here](https://forms.gle/5ZF2Zb8DM3uc7qRL7).
