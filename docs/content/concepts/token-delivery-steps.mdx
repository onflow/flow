...
### Install the Flow App
 ...
 3. In Ledger Live go to Settings > Experimental Features and turn on Developer Mode:
  ![](https://storage.googleapis.com/flow-resources/documentation-assets/token%20delivery%20assets/Ledger2.jpg)
...
### Navigate to Flow Port to Create an Address
 ...
 2. Click on 'Sign Up' if you need to create a new Flow Account.
   ...
   ![](https://storage.googleapis.com/flow-resources/documentation-assets/token%20delivery%20assets/FlowPort%20Login.png)

 3. Click on Ledger:

   ![](https://storage.googleapis.com/flow-resources/documentation-assets/token%20delivery%20assets/FlowPort%20Wallet.png)

 4. Follow the prompts on the screen. Plug in your Ledger device and open the Flow App:

   ![](https://storage.googleapis.com/flow-resources/documentation-assets/token%20delivery%20assets/FlowPort%20Ledger%20connect%20screen.png)
 ...
 7. You can easily copy it from the ‘My Account’ screen, as shown below:
    ...
    ![](https://storage.googleapis.com/flow-resources/documentation-assets/token%20delivery%20assets/FlowPort%20My%20Account.png)
