...
Flow Transactions are used to _move_ **[resources](/cadence/#intuiting-ownership-with-resources)** and interact with smart contracts on behalf of Flow accounts. `@onflow` provides flexible primitives composing authorizing and paying for Transactions on Flow.
