...
Once this is done, you can now create a Machine Account by clicking the "Upgrade Node" button on the Stake & Delegate page.

![Flow Port Staking](staking-guide.png)
