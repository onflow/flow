...
If you don't have this information, go [here](https://docs.onflow.org/concepts/nodes/nodes/node-operation/quickstart/#step-1---run-genesis-bootstrap) for instructions on how to acquire it.
...
Once this is done, you can now create a [Machine Account](/nodes/nodes/node-operation/machine-existing-operator) by clicking the "Upgrade Node" button on the Stake & Delegate page.

![Flow Port Staking](machine-account.png)

You can follow the guide [here](/nodes/nodes/node-operation/machine-existing-operator) to create your Machine Account.
