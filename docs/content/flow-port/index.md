...
### Staking your own Node
  ...
  4. Run the [bootstrapping instructions](https://docs.onflow.org/nodes/nodes/node-operation/node-bootstrap/) and provide the remaining technical details needed to stake a node.
