---
title: Flow Access API JSON RPC Specification
sidebar_title: Access API
---

The Access API is currently available as a [gRPC service](access-api). 

This is a proposed [JSON-RPC 2.0] (https://www.jsonrpc.org/specification) specification for the same API.

* It uses the standard GRPC to JSON mapping defined [here](https://developers.google.com/protocol-buffers/docs/proto3#json)
* GRPC method name translates to the same JSON RPC method name except for the first letter which is converted to lower case for JSON RPC.
e.g. Ping in GRPC becomes `ping` in JSON.
...
```Example
// Request
curl -X POST --data '{"jsonrpc":"2.0","method":"ping", "id":1, "params":[]}'
...
```Example
// Request
curl -X POST --data '{"jsonrpc":"2.0","method":"getLatestBlockHeader", "id":1, "params":[]}'
...
// Result
{
  ...
  "jsonrpc": "2.0",
  "result": "{
               "id": "0xa139ccb14317e6bac73e3c549032ab3e21b45497ab1e7049faea202df9f3c18e",
               "parentId": "0x2cdef62b2863dab60688edd929c5d86b54da51396d837e3c5f89d6b8c328bc18",
               "height": "32055420",
               "timestamp": "2021-05-12T23:52:32.594428713Z"
              }"
}
```
...
```Example
// Request
curl -X POST --data '{"jsonrpc":"2.0","method":"getBlockHeaderByID", "id":1, "params":["0xa139ccb14317e6bac73e3c549032ab3e21b45497ab1e7049faea202df9f3c18e"]}'
...
```Example
// Request
curl -X POST --data '{"jsonrpc":"2.0","method":"getBlockHeaderByHeight", "id":1, "params":[32055420]}'
...
```Example
// Request
curl -X POST --data '{"jsonrpc":"2.0","method":"getLatestBlock", "id":1", params":[]}'
