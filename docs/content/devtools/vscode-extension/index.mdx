...
This extension integrates [Cadence](/tutorial/cadence/00-introduction/), the resource-oriented smart contract programming language of [Flow](https://www.onflow.org/), into [Visual Studio Code](https://code.visualstudio.com/).
