...
If I am a node operator and I break the rules, I lose the tokens I've staked.
If I operate my node with integrity, I get rewarded with more tokens!
...
Once node's have registered, they are required to operate for a protocol-specified timeframe.
...
with other nodesfor the next epoch. These processes are called **Cluser Quorum Certificate Generation (QC)**,
...
See the [Epochs](/staking/epochs) section of the documentation for in-depth explainations 
