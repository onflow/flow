...
of the network and to receive token rewards.
...
This large distribution of resources makes it so that control never gets centralized 
in the control of one person or organization.
