...
For the **Epoch-*internal* Phase transitions**, meanin the phase transitions within an epoch,
...
See the [Epoch Setup Event Documentation](/staking/epoch-scripts-events/)
...
See the [Epoch Commit Event Documentation](/staking/epoch-scripts-events/)
