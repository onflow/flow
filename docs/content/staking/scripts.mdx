...
You can use the **Get Proposed Table**([SC.05](../../core-contracts/flow-id-table-staking/#getting-staking-info)) script for retrieving this info.
...
You can use the **Get Current Table**([SC.04](../../core-contracts/flow-id-table-staking/#getting-staking-info)) script for retrieving this info.
...
You can use the **Get Node Info**([SC.08](../../core-contracts/flow-id-table-staking/#getting-staking-info)) script
...
You can use the **Get Node Total Commitment**([SC.09](../../core-contracts/flow-id-table-staking/#getting-staking-info)) script
...
You can use the **Get Delegator Info**([SC.10](../../core-contracts/flow-id-table-staking/#getting-staking-info))
...
You can use the **Get stake requirements**([SC.02](../../core-contracts/flow-id-table-staking/#getting-staking-info)) script to retrieve this info.
...
You can use the **Get weekly payout**([SC.03](../../core-contracts/flow-id-table-staking/#getting-staking-info)) script to retrieve this info.

This script requires no arguments.

### Get the total FLOW staked:

You can use the **Get total FLOW staked**([SC.06](../../core-contracts/flow-id-table-staking/#getting-staking-info)) script to retrieve this info.

This script requires no arguments.

### Get the total FLOW staked by a single node type:

You can use the **Get total FLOW staked by node type**([SC.07](../../core-contracts/flow-id-table-staking/#getting-staking-info)) script
with the following arguments:
