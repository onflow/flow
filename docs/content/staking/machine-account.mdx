...
Machine Accounts are used in the [Epoch Preparation Protocol](https://flow-docs-cd0obzavr-onflow.vercel.app/staking/epoch-preparation/), 
...
created for your staked nodes by following [this guide](/node-operation/machine-existing-operator/).
...
We recommend a minimum balance of 0.01 FLOW for collection nodes and 1 FLOW for consensus nodes. 
