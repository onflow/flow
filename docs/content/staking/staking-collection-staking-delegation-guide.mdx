...
Transferring a Node will remove it from the authorizer's Staking Collection and deposit it to the receiver's Staking Collection.

_Note: Once a Node or Delegator has been transferred, it cannot be accessed again by the sender. As well, all staked tokens will be considered staked by the receiver's Staking Collection._
