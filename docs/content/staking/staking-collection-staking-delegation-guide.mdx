...
To register a new staked node, you must submit the **Register Node** ([SL.02](/core-contracts/staking-collection))
...
To register a new delegator, you must submit the **Register Delegator** ([SL.03](/core-contracts/staking-collection))
transaction with the following arguments:
...
A user may transfer an existing Node to another another accounts Staking Collection.

The account to transfer the Node to must have a valid Staking Collection set up.

Transferring a Node will remove it from the authorizers Staking Collection and deposit it to the receivers Staking Collection.

_Note: Once a Node or Delegator has been transferred, it cannot be accessed again by the sender. As well, all staked tokens will be considered staked by the receivers Staking Collection._

<Callout type="warning">
Transferring a Node will result in loss of custody of any Staked tokens for the sender.
</Callout>

The owner of a Staking Collection can use the **Transfer Node** ([SL.11](/core-contracts/staking-collection))
transaction with the following arguments:
...
A user may transfer an existing Delegator to another another accounts Staking Collection.

The account to transfer the Delegator to must have a valid Staking Collection set up.

Transferring a Delegator will remove it from the authorizers Staking Collection and deposit it to the receivers Staking Collection.
...
The owner of a Staking Collection can use the **Transfer Delegator** ([SL.11](/core-contracts/staking-collection))
transaction with the following arguments:
...
can use the **Get All Node Info** ([SL.14](/core-contracts/staking-collection)) script with the following arguments:
...
can use the **Get All Delegator Info** ([SL.13](/core-contracts/staking-collection)) script with the following arguments:
...
can use the **Get All Node Ids** ([SL.16](/core-contracts/staking-collection)) script with the following arguments:
...
can use the **Get All Delegator Ids** ([SL.15](/core-contracts/staking-collection)) script with the following arguments:
...
can use the **Get Locked Tokens Used** ([SL.18](/core-contracts/staking-collection)) script with the following arguments:
...
can use the **Get Unlocked Tokens Used** ([SL.19](/core-contracts/staking-collection)) script with the following arguments:
...
can use the **Get Does Node Exist** ([SL.17](/core-contracts/staking-collection)) script with the following arguments:
