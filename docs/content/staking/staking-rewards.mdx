...
```
flow events get A.8624b52f9ddcd04a.FlowIDTableStaking.RewardsPaid --start <block Height> --end <block height> -n mainnet
...
```
$ flow events get A.8624b52f9ddcd04a.FlowIDTableStaking.RewardsPaid --start 51753700 --end 51753921 -n mainnet
