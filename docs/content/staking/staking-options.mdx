...
and not what the Flow team recommends.
...
without allowing them to actually withdraw any of the locked tokens.
...
and will receive the most support in the future. It is the set-up that Flow Port uses.
