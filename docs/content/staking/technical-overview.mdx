...
the node operator submits a **Register Node** transaction,
...
If the tokens are in the committed pool, they are moved to the unstaked pool and are available to withdraw.
