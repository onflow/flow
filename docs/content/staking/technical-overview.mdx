...
network maintenance operations are performed. The schedule of each epoch is exactly the same, though
...
If there are tokens in the committed pool, they are moved to the unstaked pool and are available to withdraw.
...
You can use the **Get Proposed Table**([SC.05](../../protocol/core-contracts/flow-id-table-staking/#getting-staking-info)) script for retreiving this info.
...
You can use the **Get Current Table**([SC.04](../../protocol/core-contracts/flow-id-table-staking/#getting-staking-info)) script for retreiving this info.
...
You can use the **Get stake requirements**([SC.02](../../protocol/core-contracts/flow-id-table-staking/#getting-staking-info)) script to retreive this info.
...
You can use the **Get weekly payout**([SC.03](../../protocol/core-contracts/flow-id-table-staking/#getting-staking-info)) script to retreive this info.

This script requires no arguments.

### Get the total FLOW staked:

You can use the **Get total FLOW staked**([SC.06](../../protocol/core-contracts/flow-id-table-staking/#getting-staking-info)) script to retreive this info.
