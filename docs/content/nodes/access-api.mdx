...
The detailed semantics of transaction creation, signing and submission are covered in the [transaction submission guide](https://developers.flow.com/learn/concepts//concepts/transaction-signing).

### Proposal Key

The proposal key is used to specify a sequence number for the transaction. Sequence numbers are covered in more detail [here](https://developers.flow.com/learn/concepts//concepts/accounts-and-keys#sequence-numbers).

| Field           | Description                                                                          |
| --------------- | ------------------------------------------------------------------------------------ |
| address         | Address of proposer account                                                          |
| key_id          | ID of proposal key on the proposal account                                           |
| sequence_number | [Sequence number](https://developers.flow.com/learn/concepts//concepts/accounts-and-keys#sequence-numbers) for the proposal key |
...
More information on accounts can be found [here](https://developers.flow.com/learn/concepts//concepts/accounts-and-keys/).
...
| sign_algo       | [Signature algorithm](https://developers.flow.com/learn/concepts/concepts/accounts-and-keys#supported-signature--hash-algorithms) |
| hash_algo       | [Hash algorithm](https://developers.flow.com/learn/concepts/concepts/accounts-and-keys#supported-signature--hash-algorithms)      |
| weight          | [Weight assigned to the key](https://developers.flow.com/learn/concepts/concepts/accounts-and-keys#weighted-keys)                 |
| sequence_number | [Sequence number for the key](https://developers.flow.com/learn/concepts/concepts/accounts-and-keys#sequence-numbers)             |
| revoked         | Flag indicating whether or not the key has been revoked                                 |

More information on account keys, key weights and sequence numbers can be found [here](https://developers.flow.com/learn/concepts/concepts/accounts-and-keys/).
