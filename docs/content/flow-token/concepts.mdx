...
Please consider above numbers only as relative reference. The exact values will most likely change during implementation and be dynamically adjusted thereafter.
