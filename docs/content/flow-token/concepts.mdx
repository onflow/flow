...
Currently, all transaction fees are charged at a flat rate of 0.00001 FLOW. As of the April 6th, 2022 spork Flow supports a new fee structure called Segemented Transaction Fees. A [community vote to enable this new transaction fee methodology is in progress](https://forum.onflow.org/t/first-flow-community-vote-live-now-until-april-22/3013/3). If the proposal is accepted the new segmented transaction fee structure would be enabled in late May, 2022.
