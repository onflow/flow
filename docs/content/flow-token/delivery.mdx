...
### Setup Your Blocto Wallet to Recieve Locked FLOW

1. Open the browser inside the Blocto app.

2. Go to: https://flow-wallet.blocto.app/lock-account.

3. Follow the instructions and set up lock account. Or alternatively, on your mobile device use this link https://blocto.app.link/locked-flow. This will take users through download and open that lock account page.
