...
- Built-in pre-conditions and post-conditions for functions and [transactions](/concepts/#transaction)
...
In a resource-oriented language like Cadence, resources directly tie an asset to the [account](/cadence/language/accounts) that owns it
