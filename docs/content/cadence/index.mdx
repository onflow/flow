...
sidebar_title: Cadence Overview
description: Introduction to the Cadence programming language
---
...
Now that you've learned about the goals and design of Cadence and Flow, you're ready to get started with the Flow emulator and tools! Go to the [Getting Started](/cadence/tutorial/01-first-steps/) page to work through language fundamentals and tutorials.
