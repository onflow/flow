...
<a href="https://play.onflow.org/b9e7b3f7-41dc-49ae-8435-d8a82f7fb3aa" target="_blank">https://play.onflow.org/b9e7b3f7-41dc-49ae-8435-d8a82f7fb3aa</a> <br/>
...
<a href="https://play.onflow.org/b9e7b3f7-41dc-49ae-8435-d8a82f7fb3aa" target="_blank">https://play.onflow.org/b9e7b3f7-41dc-49ae-8435-d8a82f7fb3aa</a>
...
In this example, we use a simple `String->String` mapping, but you could imagine a much more rich
...
pub fun main() {
    ...
    let receiverRef = capability.borrow<&{ExampleNFT.NFTReceiver}>()
