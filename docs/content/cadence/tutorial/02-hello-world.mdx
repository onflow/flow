...
You can see the documentation for all of these in the Storage section of the language reference or in the [glossary](/cadence/language/accounts).
...
Note that this only allows access to field and methods. It does not allow copying, moving, or modifying the original object directly.
