...
The setup process will connect any stake or delegation records stored in an accounts associated locked account with the new Staking Collection, allowing them
