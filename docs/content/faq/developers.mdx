...
As soon as [permissionless deployment (ETA summer 2022)](https://readymag.com/tanookilabs/3705127/) is released, you can create accounts and deploy contracts to mainnet directly.

However, until then, you will need to submit your contract to the Flow team for review and then you’ll be able to submit it to the network. As soon as you’ve tested your dapp on devnet and the Flow team has reviewed your contracts, you can deploy!
