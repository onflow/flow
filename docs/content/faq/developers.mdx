...
As soon as [permissionless deployment (ETA summer 2022)](https://permissionless.onflow.org/) is released, you can create accounts and deploy contracts to mainnet directly.
