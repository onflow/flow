...
From here you can decide wether to stake or delegate.

- Select **Stake** if you plan to stake a node you;re running.
- Select **Delegate** to delegate your stake to another Node Operator. You don't need to know which Node Operator, you'll be provided with a list to choose from.

## Stake a Node

User's will be running their own nodes can stake them using the Flow Port.

#### Pre-requisites

In order to sket your node you'll need to have the required amount of locked FLOW.
...
Clicking next wil take you to a confirmation screen. This is your chance to double-ckeck that you've entered your information correctly. If you're ready, check the
box confirming your information and click submit to send the transaction to begin staking your node! You should see a transaction status screen like this:

![Flow Port Staking](port-stake-0-05.png)

**Note:** If you transaction fails, double-check the information you provided. <br/> <br/>

If you return to the home screen, you'l be able to see your staking request in progress!

![Flow Port Staking](port-stake-4.png)

## Delegating

Delegating is the pricess of staking your locked FLOW to nodes which are being run by another party.
...
Here is a list of node operator ID's you can delegate to: [List of Available Node Operators](https://github.com/onflow/flow/blob/master/nodeoperators/NodeOperatorList.md)
...
Next you'll enter an amoutn of FLOW you'd like to delegate. When delegating you may send any amout you'd like to the node operator.
...
Once you're transaction is submitted. you can monitor it's status from this screen, or return to the Flow Port home screen.

![Flow Port Staking](port-delegate-4.png)

**Note:** If you transaction fails, double-check the information you provided. <br/> <br/>

That's it! You've successfully delegated stake to yor chosen node operator!
