...
These third-party services can insulate your application from the requirement of being aware of [sporks](https://docs.onflow.org/node-operation/spork/#past-and-upcoming-sporks).
Otherwise, you will have to add logic in your application to navigate across [past sporks](https://docs.onflow.org/node-operation/spork/#past-and-upcoming-sporks) when looking up past blockchain data.
