...
As a node operator, depending on your use case, you can choose to run any of the different types of nodes which are described [here](/nodeoperation/node-roles).
...
To run an observer node, follow this [guide](/nodeoeration/observer-node).
