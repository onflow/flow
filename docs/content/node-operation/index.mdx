...
A node is a piece of software that is connected to the blockchain.
...
To run an access node, see the [Running a staked node](/node-operation/index.mdx#running-a-staked-node) section below.
