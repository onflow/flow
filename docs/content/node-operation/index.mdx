...
The different types of nodes are described [here](/nodes/node-operation/node-roles). As a node operator, you can choose to run any of the different types of node that best fits your needs.
