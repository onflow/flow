...
The public access nodes that support observer nodes are listed above. Apart from these, other public access nodes run by node operators other than DapperLabs may choose to support observer nodes.
