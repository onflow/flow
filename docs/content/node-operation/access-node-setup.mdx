...
Example ![node_details_permissionless_an](node_details_permissionless_an.png)

On the next screen, ensure that you stake 100 FLOW token.

Example ![transaction_register_node_permissionless_an](transaction_register_node_permissionless_an.png)
