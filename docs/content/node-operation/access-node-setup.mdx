...
Currently on mainnet, the staking auction starts every Wednesday at around 17:30 UTC and ends on the next Wednesday at 8:30 UTC. Hence, the node should be staked by Wednesday, 08:30 UTC to be able to join the network in the next epoch.
...
> Please ensure that you have staked the access node by **15th Feb, 2023 Wednesday 8:0 AM UTC** if you wish to run the node in the next epoch.
