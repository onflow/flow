...
If there are more than five staked candidate access nodes at the end of the staking phase of that first epoch, five of those will be selected by an on-chain random selection process and no other permissionless ANs can join until others unstake in a future epoch.
