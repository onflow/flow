...
Before starting your node, ensure it is [registered](node-bootstrap.mdx#step-2---stake-your-node) and [authorized](https://flow-docs-8kbrufdlq-onflow.vercel.app/nodes/node-operation/node-bootstrap/#confirming-authorization).
