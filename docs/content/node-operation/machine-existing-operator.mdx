...
You will now need to copy the Machine account public key and head over to [Flow Port](/flow-port/staking-guide/) to submit a transaction to create a Machine Account. 
