...
If you have an existing `consensus` or `collection` node that you registered with Flow Port before Thursday August 19th, you will need to create this Machine Account manually in order to participate in epochs.
...
You can follow the guide [here](/flow-port/machine-account-address) .
