...
Once you have generated all your keys, you will need to now submit a transaction on Flow Port to create a Machine Account for the Machine Account public key. In the output
