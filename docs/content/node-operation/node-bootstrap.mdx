...
Once you have generated all your keys, you will need to now submit a transaction on Flow Port to create a Machine Account address for the Machine Account public key. In the output
the `boostrap key` command you will see your Machine Account public key.
...
You can follow the guide [here](/flow-port/machine-account-address) to submit a transaction on [Flow Port]().
