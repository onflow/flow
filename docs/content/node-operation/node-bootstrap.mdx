...
If you had a previous node running on **mainnet 1,** you’ll need to turn it
...
This step is not applicable for this Spork. Kindly ignore this step and proceed to Step 3.

</Callout>

[Stake the Flow node](/staking/locked-staking-guide/)
