...
Flow node produce health metrics in the form of [Prometheus](https://prometheus.io) metrics, exposed from the node software on `/metrics`.
...
4. Open your browser and go the URL `http://localhost:9090/graph` to load the Prometheus Dashboard
