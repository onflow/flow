...
_If you are running on a mac, download `storage.googleapis.com/flow-genesis-bootstrap/boot-tools-m1.tar` for M1 and `storage.googleapis.com/flow-genesis-bootstrap/boot-tools-intel-mac.tar` for Intel mac._
