...
1. A day before the [upcoming mainnet spork](upcoming-sporks.mdx), change the network address for the nodes in Flow Port (using the update network address feature).
