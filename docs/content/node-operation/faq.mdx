...
Yes, an access node is [publicly accesible](https://docs.onflow.org/concepts/accessing-testnet) to submit transactions and read data from the blockchain using the
