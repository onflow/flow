...
Flow allows nodes to join/leave the network each time a new epoch begins (roughly once per week). See [Staking & Epochs](/staking/#epochs) for details.  **$$TODO link to staking order of operations$$**
