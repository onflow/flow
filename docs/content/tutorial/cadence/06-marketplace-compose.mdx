...
Open the starter code for this tutorial in the Flow Playground: <a href="https://play.onflow.org/869e869c-145e-4d36-a893-22e16a361842" target="_blank">https://play.onflow.org/869e869c-145e-4d36-a893-22e16a361842</a><br/>
...
**Before proceeding with this tutorial**, you need to complete the [Fungible Tokens](/tutorial/cadence/03-fungible-tokens/) and [Non-Fungible Token](/tutorial/cadence/04-non-fungible-tokens/) tutorials to understand how the building blocks of this smart contract work.
...
This marketplace contract has resources that function similarly to the NFT `Collection` that was explained in [Non-Fungible Tokens](/tutorial/cadence/04-non-fungible-tokens), with a few differences and additions:
