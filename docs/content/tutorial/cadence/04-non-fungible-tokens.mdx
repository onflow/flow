...
**Before proceeding with this tutorial**, we highly recommend following the instructions in [Getting Started](/tutorial/cadence/01-first-steps/), [Hello, World!](/tutorial/cadence/02-hello-world/), and [Fungible Tokens](/tutorial/cadence/03-fungible-tokens/) to learn how to use the Playground tools and to learn the fundamentals of Cadence. We will cover some of the concepts again here, but not all.
