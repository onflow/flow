...
**Before proceeding with this tutorial**, we recommend following the instructions in [Getting Started](/tutorial/cadence/01-first-steps/) and [Hello, World!](/tutorial/cadence/02-hello-world/) to learn the basics of the language and the playground.
