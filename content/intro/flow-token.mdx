...
- Kraken
- Ledger, or
- Create your own Flow account by going to [Flow Port](#) and selecting "Create Account" on the login screen, and choose via Flow Faucet.
  This will allow you to use the [Flow Faucet](#) to request an account with your own Public Key.
