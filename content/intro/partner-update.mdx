...
### Oct 8: Spork - Candidate #10

- **Key Deadline:** Wednesday October 7th @4pm Pacific Time

### Oct 16: Flow Port Release & Token Delivery

- Partners supporting Flow: Kraken, Finoa, Ledger, Flow Port (more on that below 😉)
...
- Investors will spend Oct 16 - Oct 22 staking their tokens. Partners should be ready to support investors in this process by this time.
- This will be the first spork where keys (and stake!) are collected via Staking Requests (txs sent to staking contract - described in detail in docs below).
- Staking Request Deadline: Friday October 30th @ 4pm Pacific Time
- Node Startup: Saturday October 31st @11am Pacific Time
