...
<img
  ...
  src="https://storage.googleapis.com/flow-resources/documentation-assets/cadence-tuts/accounts-diagram.png"
/>
...
<Callout type="info">Open the file `Script1.cdc`.</Callout>
...
<Callout type="info">Click the `Execute` button in the playground.</Callout>
