...
<Callout type="success">
  ...
  Open the starter code for this tutorial in the Flow Playground: <a href="https://play.onflow.org/5a5f4fdf-f499-47a4-aef7-f01713e61fde" target="_blank">https://play.onflow.org/5a5f4fdf-f499-47a4-aef7-f01713e61fde</a><br/>The tutorial will be asking you to take various actions to interact with this code.
...
```swift:title=SetupAccount1Transaction.cdc
...
```swift:title=SetupAccount2Transaction.cdc
...
```swift:title=SetupAccount1TransactionMinting.cdc
import FungibleToken from 0x01
import NonFungibleToken from 0x02
...
```swift:title=CheckSetupScript.cdc
import FungibleToken from 0x01
import NonFungibleToken from 0x02
