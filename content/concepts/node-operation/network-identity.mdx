...
Each node in the network has a _Node Identity_. A table with the identities of all legitimate nodes is maintained by the consensus committee as part of the _Protocol State_. Updates to this Protocol State are published by consensus nodes as part of their blocks.
