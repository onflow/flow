...
Users need a Flow account in order to receive, hold and send FLOW tokens. 

TODO: Link to account creation docs
...
existing investors who participate in the initial coin offering (ICO) of FLOW. 
...
The [FLOW staking documentation](/token/staking) outlines the steps a custodian can take 
