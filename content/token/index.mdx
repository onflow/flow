...
1. [Claim FLOW as an Investor](/investors): Existing Flow investors can claim their FLOW.
1. [Earn FLOW as a Validator](/staking): Receive newly-minted FLOW as a reward for running a node.
1. [Earn FLOW as a Community Member](/earn): Receive newly-minted FLOW as a reward for building on Flow.
...
[You can use FLOW for stake delegation.](/staking#delegation) Delegators receive newly-minted FLOW 
as a reward for helping to secure the network.
