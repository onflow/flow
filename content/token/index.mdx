...
and select `Create Account` on the login screen, and choose via Flow Faucet.
This will allow you to use the [Flow Faucet](#) to request your first account with your own Public Key.
