...
This section contains information about the FLOW token for individuals, investors, 
...
1. [Claim FLOW as an Investor](/token/investors): Existing Flow investors can claim their FLOW.
