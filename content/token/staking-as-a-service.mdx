---
title: Staking as a Service with FLOW
description: How to use FLOW to run a staked node on behalf of a token holder who supplies the tokens to stake
---

# Staking as a Service with Flow
...
### Delegating with the StakingHelper
...
- Withdraw rewards/unstaked tokens via `sh_withdraw_tokens.cdc` transaction,
...
- Commit rewards/unstaked tokens to stake via the `sh_stake_unlocked_tokens.cdc` transaction.
