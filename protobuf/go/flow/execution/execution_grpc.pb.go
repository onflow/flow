...
const (
	ExecutionAPI_Ping_FullMethodName                                 = "/flow.execution.ExecutionAPI/Ping"
	ExecutionAPI_GetAccountAtBlockID_FullMethodName                  = "/flow.execution.ExecutionAPI/GetAccountAtBlockID"
	ExecutionAPI_ExecuteScriptAtBlockID_FullMethodName               = "/flow.execution.ExecutionAPI/ExecuteScriptAtBlockID"
	ExecutionAPI_GetEventsForBlockIDs_FullMethodName                 = "/flow.execution.ExecutionAPI/GetEventsForBlockIDs"
	ExecutionAPI_GetTransactionResult_FullMethodName                 = "/flow.execution.ExecutionAPI/GetTransactionResult"
	ExecutionAPI_GetTransactionResultByIndex_FullMethodName          = "/flow.execution.ExecutionAPI/GetTransactionResultByIndex"
	ExecutionAPI_GetTransactionResultsByBlockID_FullMethodName       = "/flow.execution.ExecutionAPI/GetTransactionResultsByBlockID"
	ExecutionAPI_GetTransactionErrorMessage_FullMethodName           = "/flow.execution.ExecutionAPI/GetTransactionErrorMessage"
	ExecutionAPI_GetTransactionErrorMessageByIndex_FullMethodName    = "/flow.execution.ExecutionAPI/GetTransactionErrorMessageByIndex"
	ExecutionAPI_GetTransactionErrorMessagesByBlockID_FullMethodName = "/flow.execution.ExecutionAPI/GetTransactionErrorMessagesByBlockID"
...
func (c *executionAPIClient) GetTransactionResultByIndex(ctx context.Context, in *GetTransactionByIndexRequest, opts ...grpc.CallOption) (*GetTransactionResultResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetTransactionResultResponse)
	err := c.cc.Invoke(ctx, ExecutionAPI_GetTransactionResultByIndex_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *executionAPIClient) GetTransactionResultsByBlockID(ctx context.Context, in *GetTransactionsByBlockIDRequest, opts ...grpc.CallOption) (*GetTransactionResultsResponse, error) {
	...
	err := c.cc.Invoke(ctx, ExecutionAPI_GetTransactionResultsByBlockID_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *executionAPIClient) GetTransactionErrorMessage(ctx context.Context, in *GetTransactionErrorMessageRequest, opts ...grpc.CallOption) (*GetTransactionErrorMessageResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetTransactionErrorMessageResponse)
	err := c.cc.Invoke(ctx, ExecutionAPI_GetTransactionErrorMessage_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *executionAPIClient) GetTransactionErrorMessageByIndex(ctx context.Context, in *GetTransactionErrorMessageByIndexRequest, opts ...grpc.CallOption) (*GetTransactionErrorMessageResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetTransactionErrorMessageResponse)
	err := c.cc.Invoke(ctx, ExecutionAPI_GetTransactionErrorMessageByIndex_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *executionAPIClient) GetTransactionErrorMessagesByBlockID(ctx context.Context, in *GetTransactionErrorMessagesByBlockIDRequest, opts ...grpc.CallOption) (*GetTransactionErrorMessagesResponse, error) {
	...
	err := c.cc.Invoke(ctx, ExecutionAPI_GetTransactionErrorMessagesByBlockID_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *executionAPIClient) GetRegisterAtBlockID(ctx context.Context, in *GetRegisterAtBlockIDRequest, opts ...grpc.CallOption) (*GetRegisterAtBlockIDResponse, error) {
	...
	err := c.cc.Invoke(ctx, ExecutionAPI_GetRegisterAtBlockID_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *executionAPIClient) GetLatestBlockHeader(ctx context.Context, in *GetLatestBlockHeaderRequest, opts ...grpc.CallOption) (*BlockHeaderResponse, error) {
	...
	err := c.cc.Invoke(ctx, ExecutionAPI_GetLatestBlockHeader_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *executionAPIClient) GetBlockHeaderByID(ctx context.Context, in *GetBlockHeaderByIDRequest, opts ...grpc.CallOption) (*BlockHeaderResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BlockHeaderResponse)
	err := c.cc.Invoke(ctx, ExecutionAPI_GetBlockHeaderByID_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *executionAPIClient) GetTransactionExecutionMetricsAfter(ctx context.Context, in *GetTransactionExecutionMetricsAfterRequest, opts ...grpc.CallOption) (*GetTransactionExecutionMetricsAfterResponse, error) {
	...
	err := c.cc.Invoke(ctx, ExecutionAPI_GetTransactionExecutionMetricsAfter_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedExecutionAPIServer) GetTransactionErrorMessage(context.Context, *GetTransactionErrorMessageRequest) (*GetTransactionErrorMessageResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetTransactionErrorMessage not implemented")
}
func (UnimplementedExecutionAPIServer) GetTransactionErrorMessageByIndex(context.Context, *GetTransactionErrorMessageByIndexRequest) (*GetTransactionErrorMessageResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetTransactionErrorMessageByIndex not implemented")
}
func (UnimplementedExecutionAPIServer) GetTransactionErrorMessagesByBlockID(context.Context, *GetTransactionErrorMessagesByBlockIDRequest) (*GetTransactionErrorMessagesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetTransactionErrorMessagesByBlockID not implemented")
}
func (UnimplementedExecutionAPIServer) GetRegisterAtBlockID(context.Context, *GetRegisterAtBlockIDRequest) (*GetRegisterAtBlockIDResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetRegisterAtBlockID not implemented")
}
...
func (UnimplementedExecutionAPIServer) GetTransactionExecutionMetricsAfter(context.Context, *GetTransactionExecutionMetricsAfterRequest) (*GetTransactionExecutionMetricsAfterResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetTransactionExecutionMetricsAfter not implemented")
}
...
func _ExecutionAPI_GetTransactionResultByIndex_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ExecutionAPI_GetTransactionResultByIndex_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ExecutionAPI_GetTransactionResultsByBlockID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ExecutionAPI_GetTransactionResultsByBlockID_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ExecutionAPI_GetTransactionErrorMessagesByBlockID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ExecutionAPI_GetTransactionErrorMessagesByBlockID_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ExecutionAPI_GetRegisterAtBlockID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ExecutionAPI_GetRegisterAtBlockID_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ExecutionAPI_GetLatestBlockHeader_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ExecutionAPI_GetLatestBlockHeader_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ExecutionAPI_GetBlockHeaderByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ExecutionAPI_GetBlockHeaderByID_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
