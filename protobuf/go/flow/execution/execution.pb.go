...
type GetEventsForBlockIDsResponse struct {
	...
	IsCcf                bool                                   `protobuf:"varint,2,opt,name=is_ccf,json=isCcf,proto3" json:"is_ccf,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                               `json:"-"`
	XXX_unrecognized     []byte                                 `json:"-"`
	XXX_sizecache        int32                                  `json:"-"`
}
...
func (m *GetEventsForBlockIDsResponse) GetIsCcf() bool {
	if m != nil {
		return m.IsCcf
	}
	return false
...
var fileDescriptor_699624211ed46c53 = []byte{
	...
	,
}
