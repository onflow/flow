...
type ExecutionReceipt struct {
	Meta                 *ExecutionReceiptMeta `protobuf:"bytes,1,opt,name=meta,proto3" json:"meta,omitempty"`
	ExecutionResult      *ExecutionResult      `protobuf:"bytes,2,opt,name=execution_result,json=executionResult,proto3" json:"execution_result,omitempty"`
	XXX_NoUnkeyedLiteral struct{}              `json:"-"`
	XXX_unrecognized     []byte                `json:"-"`
	XXX_sizecache        int32                 `json:"-"`
}
...
func (*ExecutionReceipt) Descriptor() ([]byte, []int) {
	return fileDescriptor_806371cb5e5e336b, []int{4}
}
...
func (m *ExecutionReceipt) GetMeta() *ExecutionReceiptMeta {
	if m != nil {
		return m.Meta
	}
	return nil
...
func (m *ExecutionReceipt) GetExecutionResult() *ExecutionResult {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*ExecutionReceipt)(nil), "flow.entities.ExecutionReceipt")
}
...
var fileDescriptor_806371cb5e5e336b = []byte{
	...
	,
}
